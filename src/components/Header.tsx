        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-maroon text-warm-white px-5 py-2.5  text-sm font-semibold hover:bg-maroon-light transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-maroon focus-visible:ring-offset-2"
            >
        ...
        >
          <div className="px-4 py-4 space-y-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 bg-maroon text-warm-white px-5 py-3  text-base font-semibold hover:bg-maroon-light transition-colors"
            >
