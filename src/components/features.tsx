...
const FEATURES: Feature[] = [
  {
    ...
    body: "Disusun dengan kaidah tartil dan tajwid yang ketat — makhraj, waqaf, dan adab tilawah. Setiap hafalan diuji seperti standar IAO.",
    image:
  ...
  {
    title: "Tinjauan Asatidz",
    body: "Setiap hasil ujian ditinjau langsung oleh asatidz berpengalaman. Hafalan yang lemah tidak pernah lolos ke tahap berikutnya.",
    image:
  ...
  },
  {
    ...
    body: "Sertifikat resmi YHIE hingga akses beasiswa PSB-YHIE, dari satu proses pendaftaran. Satu niat, setiap pintu terbuka.",
    image:
  ...
  {
    title: "Akses Mudah",
    body: "Daftar, ujian, dan terima sertifikat langsung dari ponsel Anda. Seluruh proses berjalan sederhana dan tanpa hambatan.",
    image:
...
export function Features(): ReactNode {
  ...
  return (
    <div id="overview" className="scroll-mt-24 pb-24 sm:pb-32">
      <div
        ref={listRef}
