...
export default function Cta4() {
    ...
    return (
        <section className="w-full flex flex-col items-center overflow-visible">
            {/* Top Content Section */}
            <div className="max-w-[1400px] mx-auto w-full flex items-center justify-center py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
                <div className="text-center space-y-6">
                    ...
                    <motion.h1
                        ...
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-normal leading-[1.15]"
                    >
                    ...
                    >
                        <button className="group cursor-pointer relative pl-6 pr-2 py-2 bg-surface text-background font-medium text-sm sm:text-base transition-colors duration-200 flex items-center gap-3 overflow-hidden">
                            <span className="relative z-10">Join our team</span>
                            <span className="relative z-10 w-8 h-8 sm:w-10 sm:h-10 bg-dark flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
                                <FaArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-foreground" />
                            </span>
                        </button>
                    </motion.div>
                </div>
                ...
                <div className="relative">
                    ...
                    >
                        {duplicatedImages.map((image, index) => (
                            <div
                                key={`${image.id}-${index}`}
                                className={`shrink-0 w-32 h-44 sm:w-36 sm:h-48 md:w-44 md:h-56 lg:w-48 lg:h-64 ${index % 2 === 1 ? "-mt-8 sm:-mt-10 md:-mt-12 lg:-mt-16" : ""
                                    }`}
                            >
